...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, MONOLITH_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.MONOLITH_KEY),
                List.of(new PlacementModifier[]{RarityFilter.onAverageOnceEvery(1000), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top()), BiomeFilter.biome()}));
    }
