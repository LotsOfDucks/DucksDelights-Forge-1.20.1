...
@OnlyIn(Dist.CLIENT)
public class GiantClamNetherRenderer implements BlockEntityRenderer<AbstractGiantClamNetherBlockEntity> {
    private final ItemRenderer itemRenderer;


    public GiantClamNetherRenderer(BlockEntityRendererProvider.Context pContext) {
        this.itemRenderer = pContext.getItemRenderer();
    }

    public void render(AbstractGiantClamNetherBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
