...
@OnlyIn(Dist.CLIENT)
public class GiantClamEnderRenderer implements BlockEntityRenderer<AbstractGiantClamEnderBlockEntity> {
    private final ItemRenderer itemRenderer;


    public GiantClamEnderRenderer(BlockEntityRendererProvider.Context pContext) {
        this.itemRenderer = pContext.getItemRenderer();
    }

    public void render(AbstractGiantClamEnderBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
