...
public class HauntedSteelShovelItem extends ShovelItem {
    public HauntedSteelShovelItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
