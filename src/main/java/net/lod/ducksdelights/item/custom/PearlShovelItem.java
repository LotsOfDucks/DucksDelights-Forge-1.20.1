...
public class PearlShovelItem extends ShovelItem {
    public PearlShovelItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public ItemStack getRemainderItem(ItemStack oldStack) {
        ItemStack remainderItem = new ItemStack(Items.GOLDEN_SHOVEL);
