...
public class HauntedSteelSwordItem extends SwordItem {
    public HauntedSteelSwordItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
