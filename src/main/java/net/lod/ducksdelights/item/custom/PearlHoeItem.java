...
public class PearlHoeItem extends HoeItem {
    public PearlHoeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public ItemStack getRemainderItem(ItemStack oldStack) {
        ItemStack remainderItem = new ItemStack(Items.GOLDEN_HOE);
