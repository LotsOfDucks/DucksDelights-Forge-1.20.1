...
public class PearlAxeItem extends AxeItem {
    public PearlAxeItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public ItemStack getRemainderItem(ItemStack oldStack) {
        ItemStack remainderItem = new ItemStack(Items.GOLDEN_AXE);
