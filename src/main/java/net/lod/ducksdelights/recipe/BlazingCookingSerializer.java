...
public class BlazingCookingSerializer<T extends AbstractCookingRecipe> implements RecipeSerializer<T> {
    private final int defaultCookingTime;
    public final CookieBaker<T> factory;

    public BlazingCookingSerializer(CookieBaker<T> pFactory, int pDefaultCookingTime) {
